...
const QUESTIONS = [
...

  {
    ...
    justification:
      'La respuesta correcta es la opción C. En el texto se afirma: "hay que observar que es evidente por luz natural que no hay afecciones o cualidades de la nada". La razón, o una facultad de la mente, es la que nos permite concluir que la nada no tiene cualidades.',
    invalidOptions:
...

  {
    ...
    justification:
      'La respuesta correcta es la opción B, ya que la palabra "alguna" se refiere tanto a la Psychotria virids como a la Dyplopterys cabrerana. Cuando la una o la otra se mezcla con el yagé, se produce "un potente efecto sinérgico".',
    invalidOptions:
